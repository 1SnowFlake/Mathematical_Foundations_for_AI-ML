  ...
  return (
      <section className="mb-14 border-t border-border pt-10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-2xl font-semibold m-0">Gram–Schmidt in Neural Networks</h2>
        </div>

        <p className="text-lg font-medium text-foreground mt-2 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-10 mb-4">Comprehensive AI & ML Application Breakdown</h3>
