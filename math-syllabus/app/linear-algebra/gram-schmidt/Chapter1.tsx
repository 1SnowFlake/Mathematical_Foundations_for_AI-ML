  ...
  return (
      <section className="mb-14">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-2xl font-semibold m-0">Why Did We Invent Vectors?</h2>
        </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-semibold cursor-pointer ${ch1Mode === "scalar" ? "bg-accent text-white" : "bg-surface-hover text-foreground-muted"
                    }`}
                >
                  Scalar Point
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-semibold cursor-pointer ${ch1Mode === "arrow" ? "bg-accent text-white" : "bg-surface-hover text-foreground-muted"
                    }`}
                >
                  Vector Arrow
                </button>
