  ...
  return (
    <div className="prose max-w-none px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <h3 className="font-semibold text-foreground m-0 group-hover:text-accent">Graph Neural Networks</h3>
        </Link>
        ...
        <Link 
          ...
          className="p-5 rounded-xl border border-border bg-surface hover:bg-surface-hover hover:border-accent transition-all group"
        >
          <h3 className="font-semibold text-foreground m-0 group-hover:text-accent">GANs</h3>
        </Link>
        ...
        <Link 
          ...
          className="p-5 rounded-xl border border-border bg-surface hover:bg-surface-hover hover:border-accent transition-all group"
        >
          <h3 className="font-semibold text-foreground m-0 group-hover:text-accent">Regression</h3>
        </Link>
      </div>
    </div>
  );
