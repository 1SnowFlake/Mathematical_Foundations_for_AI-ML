  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-2xl font-bold m-0">Problems Before Gram–Schmidt</h2>
      </div>

      <blockquote className="border-l-4 border-amber-500 pl-4 italic text-foreground-muted my-2">
      ...
      <div className="bg-surface border border-border rounded-xl p-4 my-2">
