  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-2xl font-bold m-0">Span</h2>
      </div>
      ...
      <div className="flex flex-wrap gap-2 my-2">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-xs font-semibold cursor-pointer border ${
            ch3Preset === "plane" ? "bg-accent text-white border-accent" : "bg-surface text-foreground-muted border-border"
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-xs font-semibold cursor-pointer border ${
            ch3Preset === "line" ? "bg-accent text-white border-accent" : "bg-surface text-foreground-muted border-border"
          }`}
        >
